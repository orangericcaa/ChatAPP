...
from Client.model.Model import User, Message, Response
import json
import socket
import Client.config.Const_for_Communication as Const
import time
import hashlib
import threading
...
class PeerSender:
    ...
    def __send_pic(self, post: str):
        ...
        img_path = os.path.join(BASE_DIR, 'imgs', f'{pic_no}.jpg')
        secret_img = lsb.hide(img_path, post)
        bytes_io = io.BytesIO()
...
if __name__ == '__main__':
    ...
    my_email, friend_email = '202695135@qq.com', '3170194169@qq.com'
    if hint == '1':
