from Client.function.Communication import *
...
db_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'db', 'message.db'))
...
def recv_message(email, time_stamp, message_recv):
    ...
    global client_account
    #print("recv_called")
    message_db_con = sqlite3.connect(db_path)
